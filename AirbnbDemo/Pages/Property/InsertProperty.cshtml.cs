...
public class InsertPropertyModel : PageModel
{
   private readonly UnitOfWork _unitOfWork;
        ...
        [BindProperty]
        public PropertyInfo objProduct { get; set; }
        ...
        public IEnumerable<SelectListItem> CalenderAvaliability { get; set; }
        ...
        public IActionResult OnGet(int? id)
        {
            ...
            {
                objProduct = _unitOfWork..GetById(id);
            }
